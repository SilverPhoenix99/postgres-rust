...
mod tests {
    ...
    #[test_case("bit"                            => Ok(Bit(Some(vec![IntegerConst(1)]))))]
    #[test_case("bit(77)"                        => Ok(Bit(Some(vec![IntegerConst(77)]))))]
    #[test_case("bit varying"                    => Ok(Varbit(None)))]
    #[test_case("char"                           => Ok(Bpchar { length: Some(1) }))]
    #[test_case("char(4)"                        => Ok(Bpchar { length: Some(4) }))]
    #[test_case("character"                      => Ok(Bpchar { length: Some(1) }))]
    #[test_case("character(2)"                   => Ok(Bpchar { length: Some(2) }))]
    #[test_case("nchar"                          => Ok(Bpchar { length: Some(1) }))]
    #[test_case("nchar(9)"                       => Ok(Bpchar { length: Some(9) }))]
    #[test_case("national char"                  => Ok(Bpchar { length: Some(1) }))]
    #[test_case("national char(7)"               => Ok(Bpchar { length: Some(7) }))]
    #[test_case("national character"             => Ok(Bpchar { length: Some(1) }))]
    #[test_case("national character(8)"          => Ok(Bpchar { length: Some(8) }))]
    #[test_case("interval"                       => Ok(IntervalRange::default().into()))]
    #[test_case("interval day"                   => Ok(IntervalRange::Day.into()))]
    #[test_case("interval(5)"                    => Ok(IntervalRange::Full { precision: Some(5) }.into()))]

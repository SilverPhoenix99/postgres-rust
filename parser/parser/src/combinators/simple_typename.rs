...
use elog::parser::ParserErrorKind::FloatPrecisionOverflow;
use elog::parser::ParserErrorKind::FloatPrecisionUnderflow;
...
use postgres_parser_ast::TypeName::Bit;
use postgres_parser_ast::TypeName::Bool;
use postgres_parser_ast::TypeName::Bpchar;
use postgres_parser_ast::TypeName::Float4;
use postgres_parser_ast::TypeName::Float8;
use postgres_parser_ast::TypeName::Generic;
use postgres_parser_ast::TypeName::Int2;
use postgres_parser_ast::TypeName::Int4;
use postgres_parser_ast::TypeName::Int8;
use postgres_parser_ast::TypeName::Json;
use postgres_parser_ast::TypeName::Numeric;
use postgres_parser_ast::TypeName::Time;
use postgres_parser_ast::TypeName::TimeTz;
use postgres_parser_ast::TypeName::Timestamp;
use postgres_parser_ast::TypeName::TimestampTz;
use postgres_parser_ast::TypeName::Varbit;
use postgres_parser_ast::TypeName::Varchar;
use postgres_parser_lexer::Keyword as Kw;
use postgres_parser_lexer::Keyword::Bigint;
use postgres_parser_lexer::Keyword::Boolean;
use postgres_parser_lexer::Keyword::Char;
use postgres_parser_lexer::Keyword::Character;
use postgres_parser_lexer::Keyword::Dec;
use postgres_parser_lexer::Keyword::Decimal;
use postgres_parser_lexer::Keyword::Double;
use postgres_parser_lexer::Keyword::Float;
use postgres_parser_lexer::Keyword::Int;
use postgres_parser_lexer::Keyword::Integer;
use postgres_parser_lexer::Keyword::National;
use postgres_parser_lexer::Keyword::Nchar;
use postgres_parser_lexer::Keyword::Precision;
use postgres_parser_lexer::Keyword::Real;
use postgres_parser_lexer::Keyword::Smallint;

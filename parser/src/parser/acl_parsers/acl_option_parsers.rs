impl Parser<'_> {
    ...
    pub(in crate::parser) fn def_acl_option_list(&mut self) -> ScanResult<Vec<AclOption>> {
    ...
    /// Alias `DefACLOption`
    pub(in crate::parser) fn def_acl_option(&mut self) -> ScanResult<AclOption> {
...
mod tests {
    use super::*;
    use crate::parser::ast_node::{AclOption::*, RoleSpec::*};

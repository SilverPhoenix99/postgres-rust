...
pub(in crate::parser::combinators) fn many<P>(parser: P) -> ManyCombi<P>
where
    P: Combinator
{
    ManyCombi(parser)
...
///
/// Returns `Err(NoMatch)` or `Err(Eof)`, if empty.
pub(in crate::parser::combinators) fn many_pre<P, Q>(first: P, follow: Q) -> ManyPrefixedCombi<P, Q>
where
    P: Combinator,
...
///
/// Returns `Err(NoMatch)` or `Err(Eof)`, if empty.
pub(in crate::parser::combinators) fn many_sep<S, P>(separator: S, parser: P) -> ManySepCombi<S, P>
where
    S: Combinator,
    P: Combinator,
{
...
////////////////////////////////////////////////////////////////////////////////////////////////
#[derive(Debug)]
pub(in crate::parser::combinators) struct ManyCombi<P>(P);
...
////////////////////////////////////////////////////////////////////////////////////////////////
#[derive(Debug)]
pub(in crate::parser::combinators) struct ManyPrefixedCombi<P, Q> {
    first: P,
    follow: Q
}
...
////////////////////////////////////////////////////////////////////////////////////////////////
#[derive(Debug)]
pub(in crate::parser::combinators) struct ManySepCombi<S, P> {
    separator: S,
    parser: P,
}

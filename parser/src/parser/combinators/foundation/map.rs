...
pub(in crate::parser::combinators) fn map_result<P, M, O>(parser: P, mapper: M) -> MapResultCombi<P, M, O>
where
    P: Combinator,
...
pub(in crate::parser::combinators) fn map<P, O>(parser: P, mapper: impl Fn(P::Output) -> O)
...
pub(in crate::parser::combinators) fn map_err<P>(parser: P, mapper: impl Fn(ScanErrorKind) -> ScanErrorKind)
...
pub(in crate::parser::combinators) struct MapResultCombi<P, M, O> {
    parser: P,
    mapper: M,
    boo: PhantomData<O>
}

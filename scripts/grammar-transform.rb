####################################################################################################
# Parses and transforms the `gram.y` file from the PostgreSQL source code into an LL(*) grammar.
####################################################################################################
...
if __FILE__ == $PROGRAM_NAME
  GrammarTransform.run! $ARGV[0], $ARGV[1]
end
...
grammar = GrammarTransform.transform('../../postgres/src/backend/parser/gram.y');

Clipboard.copy grammar.to_bison
